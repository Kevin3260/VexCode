...
#pragma config(Sensor, dgtl2,  resetMode,      sensorTouch)
...
void setSlowSpeed()
{
	if(SensorValue[slowSelector] <=200) // This sets the speed to a reasonal amount if the value is very low so that if the sensor becomes...
